    ...
    "logs_collected": {
      "files": {
        "collect_list": [
          ...
          {
            "file_path": "/var/log/aws-clive/acm-cert-retriever.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "{instance_id}-acm-cert-retriever.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/aws-clive/emr-setup.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "{instance_id}-emr-setup.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/aws-clive/update_dynamo_sh.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "{instance_id}-update_dynamo_sh.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/aws-clive/download_scripts.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "{instance_id}-download-scripts.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/aws-clive/config_hcs.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
          ...
          {
            "file_path": "/var/log/aws-clive/e2e.log",
